...
const registerSchema = z.object({
  ...
  password: z
    ...
    .regex(new RegExp(`^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*${PASSWORD_SPECIAL.source})`), 'Password must include uppercase, lowercase, number, and special character'),
...
export default function RegisterScreen() {
  ...
  const { registerStep1, isRegistering, registerError, registerErrorStatus } = useAuth({
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value, ref } }) => (
                <Input
                  ref={ref} label="Email address" placeholder="john@example.com"
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value, ref } }) => (
                <Input
                  ref={ref} label="Password" placeholder="e.g. SecurePass123!"
                  secureTextEntry
                  value={value} onChangeText={onChange} onBlur={onBlur}
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value, ref } }) => (
                <Input
                  ref={ref} label="Confirm password" placeholder="Repeat your password"
                  secureTextEntry
                  value={value} onChangeText={onChange} onBlur={onBlur}
                  error={errors.confirmPassword?.message}
                  leftIcon="lock-closed-outline" isRequired
                />
              )}
            />
